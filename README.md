...
> [!IMPORTANT]
> This branch is an internal fork of Gitea v1.27.1. It adds native organization project management and is deployed as a single customized Gitea service. Internal build, migration, deployment, recovery, and acceptance instructions are maintained in [`ops/`](ops/README.md).
