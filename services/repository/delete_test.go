...
func TestDeleteRepositoryDirectlyPurgesRepoScopedRows(t *testing.T) {
	...
	unittest.AssertExistsAndLoadBean(t, &orgproject_model.Repository{RepositoryID: 1})
	...
	unittest.AssertNotExistsBean(t, &orgproject_model.Repository{RepositoryID: 1})
	unittest.AssertExistsAndLoadBean(t, &orgproject_model.Project{ID: 1})
}
