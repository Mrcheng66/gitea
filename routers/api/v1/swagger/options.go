...
type swaggerParameterBodies struct {
	...
	// in:body
	CreateOrgProjectOption api.CreateOrgProjectOption
	// in:body
	EditOrgProjectOption api.EditOrgProjectOption
	// in:body
	LinkOrgProjectRepositoryOption api.LinkOrgProjectRepositoryOption
	// in:body
	UpdateOrgProjectConfigOption api.UpdateOrgProjectConfigOption
	// in:body
	ValidateOrgProjectConfigOption api.ValidateOrgProjectConfigOption
	// in:body
	PublishOrgProjectConfigOption api.PublishOrgProjectConfigOption
	// in:body
	RollbackOrgProjectConfigOption api.RollbackOrgProjectConfigOption
